...
say "Дышим" -o 1.aiff
ffmpeg -y -i 1.aiff -acodec mp3 1.mp3
...
say "Планирование завершено!" -o 6.aiff
ffmpeg -y -i 6.aiff -acodec mp3 6.mp3
...
say "Практика дня: Расхламинго. \
     ...
     Выполните её и насладитесь результатом." -o 7.aiff
ffmpeg -y -i 7.aiff -acodec mp3 7.mp3
...
say "Практика дня: 2 минуты ничего не делать. \
     ...
     Наблюдайте как мысли одна за другой сменяют друг друга и позволяйте этому быть." -o 8.aiff
ffmpeg -y -i 8.aiff -acodec mp3 8.mp3
...
Повторите действие для остальных таких задач." -o 9.aiff
ffmpeg -y -i 9.aiff -acodec mp3 9.mp3
...
" -o 10.aiff
ffmpeg -y -i 10.aiff -acodec mp3 10.mp3
